              ...
              <div className="mt-3 space-y-2">
                {filteredRecents.map((name) => (
                  <button
                    key={name}
                    type="button"
                    className="w-full rounded-lg px-2 py-1.5 text-left text-[14px] text-black/70 hover:bg-black/5"
                  >
                    {name}
                  </button>
                ))}
                ...
                <div className="mx-auto w-full max-w-[760px] space-y-4">
                  {messages.map((m, idx) => (
                    <div
                      ...
                      className={
                        m.role === "user"
                          ? "ml-auto w-fit max-w-[90%] rounded-2xl bg-white px-4 py-2 text-[14px] text-black/80 shadow-sm"
                          : "mr-auto w-fit max-w-[90%] rounded-2xl bg-black/5 px-4 py-2 text-[14px] text-black/80"
                      }
                    >
                      {m.text}
                    </div>
